...
.hero p{color:var(--text2);font-size:13.5px;position:relative;z-index:1;line-height:1.6}
.hero-actions{margin-top:18px;display:flex;gap:10px;position:relative;z-index:1;flex-wrap:wrap}
