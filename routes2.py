...
<section class="hero">
  ...
  <div class="hero-inner">
    <div>
      ...
      <div class="hero-note rv">7-day free trial · No credit card · Cancel any time</div>
    </div>
...
<section class="section" id="pricing" style="background:var(--s1)">
  <div class="section-inner">
    ...
    <p class="section-lead rv">Start free for 7 days. No credit card required to begin.</p>
    <div class="price-grid rv">
      <div class="pc">
        <div class="pc-icon">🆓</div>
        <div class="pc-name">Free Trial</div>
        <div class="pc-amount">₹0</div>
        <div class="pc-period">7 days</div>
        <ul class="pc-feats">
  ...
  <div class="section-inner">
    <div class="cta-banner rv">
      ...
      <p class="cta-banner-sub">
        Start your free 7-day trial today. Set up your school in under 5 minutes.<br>
      ...
      <div class="cta-note">7-day free trial · Setup takes under 5 minutes · All data stays yours</div>
    </div>
  </div>
</section>
